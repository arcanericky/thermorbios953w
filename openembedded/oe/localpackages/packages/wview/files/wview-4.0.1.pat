...
+++ wview-4.0.1-mods/./stations/BW9xx/bw9xx.c	2008-09-22 07:33:33.000000000 -0500
@@ -0,0 +1,835 @@
+/*---------------------------------------------------------------------------
+ 
+  FILENAME:
...
-    echo "# one of Simulator, VantagePro, WXT510, WS-2300, WMR918:"  >> $WVIEW_CONF_DIR/wview.conf
...
@@ -589,8 +592,8 @@
 {
     ...
     echo "-------------------------------------------------------------"
-    echo "Valid Station Types: VantagePro, Simulator, WXT510, WS-2300, WMR918"
-    echo "What weather station do you have (one of VantagePro, Simulator, WXT510, WS-2300, WMR918):"
