...
INSERT INTO "config" VALUES('FTP_BINARY','/usr/bin/tnftp','FTP Binary Full Path:','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_ARGS','-iV','FTP Binary options:','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_1_SOURCE','*.png','(1 of 10) Source file (relative to $prefix/var/wview/img):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_1_INTERVAL','5','Transmit interval (mins):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_2_SOURCE','*.htm','(2 of 10) Source file (relative to $prefix/var/wview/img):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_2_INTERVAL','5','Transmit interval (mins):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_3_SOURCE','*.html','(3 of 10) Source file (relative to $prefix/var/wview/img):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_3_INTERVAL','5','Transmit interval (mins):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_4_SOURCE','*.xml','(4 of 10) Source file (relative to $prefix/var/wview/img):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_4_INTERVAL','5','Transmit interval (mins):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_5_SOURCE','Archive/*.txt','(5 of 10) Source file (relative to $prefix/var/wview/img):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_5_INTERVAL','5','Transmit interval (mins):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_6_SOURCE','NOAA/*.txt','(6 of 10) Source file (relative to $prefix/var/wview/img):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_6_INTERVAL','5','Transmit interval (mins):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_7_SOURCE','','(7 of 10) Source file (relative to $prefix/var/wview/img):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_7_INTERVAL','0','Transmit interval (mins):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_8_SOURCE','','(8 of 10) Source file (relative to $prefix/var/wview/img):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_8_INTERVAL','0','Transmit interval (mins):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_9_SOURCE','','(9 of 10) Source file (relative to $prefix/var/wview/img):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_9_INTERVAL','0','Transmit interval (mins):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_10_SOURCE','','(10 of 10) Source file (relative to $prefix/var/wview/img):','ENABLE_FTP');
INSERT INTO "config" VALUES('FTP_RULE_10_INTERVAL','0','Transmit interval (mins):','ENABLE_FTP');
...
INSERT INTO "config" VALUES('EMAIL_ADDRESS','address@server.com','Destination for email alerts:',NULL);
